...
public class OneOperationEncryptedScenarion extends Scenario {


    public OneOperationEncryptedScenarion() {
        super("Realm one  operation encrypted");
    }
    ...
    public long runScenario() {
        ...
        user.setEmail("amilau@gmail.com");
